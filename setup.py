...
setuptools.setup(
    ...
    install_requires=["pandas[excel, performance, plot, output-formatting, computation, output-formatting]", "scikit-learn", "requests","pint", "ipykernel", "seaborn", "molmass", "pint-pandas"],
