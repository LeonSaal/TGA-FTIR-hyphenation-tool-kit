...
| Plotting      | Integration plot: add legend and reduce padding between subfigures                     |             |
| General       | Reduce amount of logging (adjust level to DEBUG)                                       |             |
| General       | Add `**kwargs` to every function for flexibility                                       |             |
| General       | Convert `setup.py` to `pyproject.toml`                                                 |             |
...
| Fitting       | Make arrows narrower and labels outside box area                                       |             |
